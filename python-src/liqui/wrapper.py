...
class Liqui(Exchange):
    def __init__(self):
        ...
        self.symbols = ['BTC','ETH','GNT','ICN','LTC','MLN','REP','USDT','TRST','WAVES','RLC','DASH','BAT','ANT','QRL','BNT','SNGLS','SNT','STORJ','ADX','OMG','CVC','DGD','BCC','ZRX','DNT','OAX','KNC','SALT','ENG','AST','REQ','MANA','VEN','AION']
