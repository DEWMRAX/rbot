...
class api(object):
    ...
    def buy_limit(self, market, quantity, rate):
        ...
        :rtype : dict
        """
        return self.api_query('buylimit', {'market': market, 'quantity': quantity, 'rate': rate, "ImmediateOrCancel": True})
    ...
    def sell_limit(self, market, quantity, rate):
        ...
        :rtype : dict
        """
        return self.api_query('selllimit', {'market': market, 'quantity': quantity, 'rate': rate, "ImmediateOrCancel": True})
    ...
    def withdraw_message(self, currency, quantity, address, message):
        return self.api_query('withdraw', {'currency': currency, 'quantity': quantity, 'address': address, 'paymentid': message})
