import httplib, urllib, urllib2, json, datetime, hashlib, hmac, sys, time
...
class api:
    ...
    def api_query(self, command, req={}):
        ...
        if(command == "returnTicker" or command == "return24Volume"):
            ...
            self.conn.request("GET", 'https://poloniex.com/public?command=' + command + '&currencyPair=' + str(req['currencyPair']))
            ...
            # print post_data
            # self.conn.request("POST", "/tradingApi", post_data, headers)#
            # ret = self.conn.getresponse()
            try:
    ...
    def withdraw_message(self, currency, amount, address, message):
        return self.api_query('withdraw',{"currency":currency, "amount":amount, "address":address, "paymentId":message})
