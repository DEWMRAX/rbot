...
ALL_PAIRS = [
    ...
    Pair('VET', 'BTC', friction(0.008)),
    Pair('VET', 'ETH', friction(0.008)),

    Pair('AION', 'BTC', friction(0.008)),
    Pair('AION', 'ETH', friction(0.008)),
]

ALL_SYMBOLS=['USD','BTC','ETH','GNT','ICN','LTC','MLN','REP','USDT','TRST','WAVES','XEM','RLC','AMP','DASH','SC','LBC','BAT','ANT','QRL','BNT','SNGLS','SNT','STORJ','ADX','OMG','QTUM','CVC','DGD','BCC','ZRX','STRAT','SYS','DNT','OAX','KNC','FUN','SALT','ENG','AST','RCN','KMD','ARK','XMR','POWR','ZEC','ADA','REQ','XRP','LSK','MANA','XLM','NEO','DCR','BNB','VET','ELF','AION','PART','NANO','GNO']
