...
class Pair(namedtuple('Pair', ['token','currency','network_friction'])):
    ...
    def maker_network_friction(self):
        return Decimal(2) * self.network_friction
...
ALL_PAIRS = [
    ...
    Pair('BCH', 'BTC', friction(0.008)),
    Pair('BCH', 'ETH', friction(0.006)),

    Pair('ATOM', 'BTC', friction(0.005)),
    Pair('ATOM', 'ETH', friction(0.003)),

    Pair('BTC', 'USD', friction(0.003)),
    Pair('LTC', 'USD', friction(0.002)),
    Pair('ETH', 'USD', friction(0.002)),
    Pair('BCH', 'USD', friction(0.002)),
...
ALL_SYMBOLS=['USD','BTC','ETH','LTC','BCH','XRP','XLM','XMR','ADA','BAT','CVC','ZRX','KNC','RCN','MANA','BNB','DNT','PART','ATOM']
