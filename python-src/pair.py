...
# I guess we are targetting MAX_NOTIONAL to be around $1000
MAX_NOTIONAL={"BTC":Decimal('.1'), "ETH":Decimal('2'), "USDT":Decimal('1000')}
...
ALL_PAIRS = [
    ...
    Pair('HMQ', 'BTC', friction(0.01)),
    Pair('HMQ', 'ETH', friction(0.007)),
    ...
    Pair('1ST', 'BTC', friction(0.01)),
    Pair('1ST', 'ETH', friction(0.007)),
    ...
    Pair('LUN', 'BTC', friction(0.008)),
    Pair('LUN', 'ETH', friction(0.006)),
